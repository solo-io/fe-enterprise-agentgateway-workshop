...
| [Semantic Routing with vLLM Semantic Router](../labs/routing/configure-semantic-routing.md) | One virtual model name, routed to a cheap or frontier model by prompt content via ExtProc |
