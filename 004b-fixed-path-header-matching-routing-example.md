...
curl $GATEWAY_IP:8080/openai -H "content-type: application/json" -H "model: gpt-3.5-turbo" -d'{
"model": "",
"messages": [
  {
    "role": "user",
...
```bash
curl $GATEWAY_IP:8080/openai -H "content-type: application/json" -H "model: gpt-4o-mini" -d'{
"model": "",
"messages": [
  {
    "role": "user",
...
```bash
curl $GATEWAY_IP:8080/openai -H "content-type: application/json" -H "model: gpt-4o" -d'{
"model": "",
"messages": [
  {
    "role": "user",
