...
Navigate to http://localhost:3000 or http://localhost:16686 in your browser, you should be able to see our system prompt was injected in the `gen_ai.prompt` tag
```
{
  "key": "gen_ai.prompt",
  "type": "string",
...
## Cleanup
```bash
kubectl delete agentgatewayenterprisepolicy -n gloo-system openai-opt
